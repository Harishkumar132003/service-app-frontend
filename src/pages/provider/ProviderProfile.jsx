...
export default function ProviderProfile() {
  ...
  return (
    <Box sx={{ bgcolor: '#f8fafc', minHeight: '100vh' }}>
      <Box sx={{ background: 'linear-gradient(135deg, #0284c7 0%, #0c70a6 100%)', height: 100 }} />
      <Container maxWidth="sm" sx={{ mt: -6, pb: 6 }}>
        <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: '1px solid #e2e8f0' }}>
          <Stack spacing={1}>
            <Typography variant="h6" sx={{ fontWeight: 700 }}>Profile</Typography>
            <Typography variant="body2" color="text.secondary">View your account information</Typography>
          </Stack>
          <Divider sx={{ my: 2 }} />
